...
import com.example.jsimmons.BuildConfig;
import com.example.jsimmons.GCMIntentService;
...
public class PrefStore {
	...
	private String PREFS_NAME = "BuckUp";

	public PrefStore(Context context) {
		this.mAct = context;
	}

	public PrefStore(GCMIntentService mContext) {
		this.mAct = mContext;
	}
	...
	/*
	 * public String getFBToken() { SharedPreferences mPrefs = mAct.getSharedPreferences(PREFS_NAME, 0); String
	 * access_token = mPrefs.getString("access_token", null); return access_token; } public long getFBTokenExpire() {
	 * SharedPreferences mPrefs = mAct.getSharedPreferences(PREFS_NAME, 0); long expires =
	...
	/*
	 * public void setFBData(String accessToken, long accessExpires, String id, String email) { SharedPreferences mPrefs
	 * = mAct.getSharedPreferences(PREFS_NAME, 0); SharedPreferences.Editor editor = mPrefs.edit();
	 * editor.putString("access_token", accessToken); editor.putString("fb_id", id); editor.putString("fb_email",
	 * email); editor.putLong("access_expires", accessExpires); editor.commit(); }
	 */

	/*
	 * public void cleanFBSession() { SharedPreferences settings = mAct.getSharedPreferences(PREFS_NAME, 0);
	 * SharedPreferences.Editor editor = settings.edit(); editor.remove("access_token");
